...
public class ProfessorController {
    ...
    @PostMapping("")
    public ModelAndView create(@Validated RequisicaoFormProfessor requisicao, BindingResult bindingResult) {
    ...
    @PostMapping("/{id}")
    public ModelAndView update(@PathVariable Long id, @Validated RequisicaoFormProfessor requisicao, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            ModelAndView mv = new ModelAndView("professores/edit");
